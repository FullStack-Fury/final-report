...
| Sprint Goal & User Stories      |
| Sprint 2 Goal                   | Nuestro enfoque es crear una versión integrada del landing page y la aplicación web. Además, ofrecer una primera versión del frontend de la aplicación web. Creemos que la conexión entre el landing page y la aplicación web fomentará el uso de la aplicación por parte de los visitantes. Por otro lado, la primera versión del front end de la aplicación web le permitira al usuario probar las funciones principales de nuestra aplicación web. Sabremos que hemos logrado nuestra meta cuando los usuarios que ingresan al landing puedan acceder a la aplicación web en la cual puedan probar las funciones principales que ofrecemos |
