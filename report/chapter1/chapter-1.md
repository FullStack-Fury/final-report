...
- [Capítulo II Requirements Elicitation \& Analysis](#capítulo-ii-requirements-elicitation--analysis)
    ...
    - [2.2. Entrevistas](#22-entrevistas)
        ...
        - [2.2.3. Análisis de entrevistas](#223-registro-de-entrevistas)
...
- [Capítulo V Product Implementation, Validation \& Deployment](#capítulo-v-product-implementation-validation--deployment)
    ...
    - [5.2. Landing Page, Services \& Applications Implementation](#52-landing-page-services--applications-implementation)
        ...
        - [5.2.4. Sprint 4](#523-sprint-3)
            ...
            - [5.2.4.2. Sprint Backlog 4](#5232-sprint-backlog-3)
...
Además, nuestra solución automatiza el cálculo de salarios, bonificaciones, descuentos y retenciones, y proporciona un control detallado del inventario de equipos y recursos con valoraciones contables precisas. Con EduSpace, las instituciones educativas pueden optimizar la administración de sus espacios y recursos, mejorando la eficiencia operativa y la comunicación interna.
...
| <img src="https://github.com/user-attachments/assets/2a5188a5-e379-4f3d-923c-34c853b02878" alt="logo-NutriSend" width="500"/>          | Espinoza Vivas, Camila Leonor    | U202214572           | Ingenieria de Software | Soy Camila, actualmente estudio la carrera de  ingeniería de software en la Universidad Peruana de Ciencias Aplicadas UPC. Me considero una persona responsable y con sentido de liderazgo y poseo conocimiento de múltiples lenguajes de programación, así como un sólido entendimiento de estructuras de datos y algoritmos. |
| ![Foto](../../assets/Ariana.png) | Huapaya Buitron, Ariana Alheli   | U201819645           | Tengo conocimientos en programación en C++ y Python. Además, soy bueno haciendo cálculos matemáticos, me comprometo a apoyar a mi equipo en todo lo posible y ser responsable con cada actividad que se me asigne.                                                                                                                                                            |
